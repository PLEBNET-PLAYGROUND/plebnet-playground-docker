...
alias bos="docker run -it --rm -v $PWD/volumes/lnd_datadir:/root/.lnd/:ro -v $PWD/volumes/bos:/home/node/.bos:rw --network plebnet-playground-docker_default alexbosworth/balanceofsatoshis"
```
